class Seq:
    ...
    def count_base(self):
        ...
        for b in self.strbases:
            ...
            if b == 'C':
                counter_c += 1
        nb = 'As:{} '.format(counter_a)+'Ts:{} '.format(counter_t)+'Gs:{} '.format(counter_g)+'Cs:{}'.format(counter_c)
        return nb
    ...
    def perc_bases(self):
        ...
        pb = 'As:{}% '.format(perc_a) + 'Ts:{}% '.format(perc_t) + 'Gs:{}% '.format(perc_g) + 'Cs:{}% '.format(perc_c)
        return pb
